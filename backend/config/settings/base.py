"""
Base settings for Society App backend.
"""
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "REST API for Society Management Application",
    "VERSION": "1.0.0",
...
# OTP
OTP_PROVIDER = env("OTP_PROVIDER")  # mock or twilio
OTP_LENGTH = 6
